...
class Trainer:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "custom_hyperparameters" in kwargs:
            self.custom_hyperparameters = kwargs.pop("custom_hyperparameters")
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> float:
        ...
        inputs["custom_hyperparameters"] = self.custom_hyperparameters
