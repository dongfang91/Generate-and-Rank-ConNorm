...
class InputExample:
    ...
    endings: List[str]
    label: Optional[str]
    semantic_labels: Optional[List[int]]
        ...
        def __init__(
            ...
            with FileLock(lock_path):
                ...
                if os.path.exists(cached_features_file) and not overwrite_cache:
                    ...
                    label_list = processor.get_labels(n_labels)
                    if mode == Split.dev:
...
processors = {"race": RaceProcessor, "swag": SwagProcessor, "arc": ArcProcessor, "syn": SynonymProcessor, "n2c2": n2c2Processor}
MULTIPLE_CHOICE_TASKS_NUM_LABELS = {"race", 4, "swag", 4, "arc", 4, "syn", 5, "n2c2", 30}
